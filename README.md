...
Some challenges of mine while building this app were:
**Dynamic Filtering**: Implementing the search bar to dynamically filter games while ensuring the displayed results updated seamlessly without page reloads.
**Data Handling**: Parsing and manipulating JSON data to accurately display game information, including contributions and funding status, in a clean and organized manner.
